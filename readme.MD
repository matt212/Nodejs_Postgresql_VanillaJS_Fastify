...
>*`Please note if you have node/postgres/redis server installed in your instance/machine`*
*`just comment the install information in primarySetup.sh file and then run this file `*
