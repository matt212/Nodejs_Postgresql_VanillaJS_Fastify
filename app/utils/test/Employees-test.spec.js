...
describe('Begin Tests', function () {
  ...
  //   })
  // })
  describe('****************Break Search  Test Cases****************', function () {
    
      it(`Searching for  and getting expected Multi recordset `, function () {
        testbase.apiUrl = '/' + evalModulename + genSpecs.dep.searchtype[1] 
        testbase.payload = {
          searchparam: [
            { first_name: ['jzrlfvibvaglnyozjftjrbzszdtdxbjdgdbcrbpxmgoec'] },
            { last_name: ['jnznotrclzyvcbokfgykxanmnahrhmmjdysgluluqzzqz'] },
