...
var mycatdata = function(arg) {


    var getapplocation = path.dirname(process.mainModule.filename).replace('routes', '') + "/public/uploadcontent";
    var saveTo = path.join(getapplocation, arg.saveTo);
    var internobj = {}
    internobj.saveTo = arg.saveTo.toString()
...
exports.dynamcatdata = mycatdata;